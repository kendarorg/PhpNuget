...
return array(
    'ApiBase' => $baseDir . '/src/inc/commons/apibase.php',
    'ApiNugetBase' => $baseDir . '/src/inc/api_nuget.php',
    'ApiNugetBaseV1' => $baseDir . '/src/inc/api_nuget.php',
    'ApiNugetBaseV2' => $baseDir . '/src/inc/api_nuget.php',
    'ApiNugetBaseV3' => $baseDir . '/src/inc/api_nugetv3.php',
    'Batcher' => $baseDir . '/src/api/v2/batch.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'GalleryController' => $baseDir . '/src/inc/gallerycontroller.php',
    'HttpUtils' => $baseDir . '/src/inc/commons/http.php',
    'IdentifyResult' => $baseDir . '/src/inc/commons/objectsearch.php',
    'LoginController' => $baseDir . '/src/inc/logincontroller.php',
    'MySqlDb' => $baseDir . '/src/inc/commons/mysqldb.php',
    'NuGetDb' => $baseDir . '/src/inc/db_nugetpackages.php',
    'NugetDependency' => $baseDir . '/src/inc/db_nugetpackagesentity.php',
    'NugetDependencyGroup' => $baseDir . '/src/inc/db_nugetpackagesentity.php',
    'NugetManager' => $baseDir . '/src/inc/nugetreader.php',
    'ObjectSearch' => $baseDir . '/src/inc/commons/objectsearch.php',
    'Operator' => $baseDir . '/src/inc/commons/objectsearch.php',
    'PHPMailer' => $baseDir . '/src/inc/PHPMailer/class.phpmailer.php',
    'PHPMailerOAuth' => $baseDir . '/src/inc/PHPMailer/class.phpmaileroauth.php',
    'PHPMailerOAuthGoogle' => $baseDir . '/src/inc/PHPMailer/class.phpmaileroauthgoogle.php',
    ...
    'POP3' => $baseDir . '/src/inc/PHPMailer/class.pop3.php',
    'PackageDescriptor' => $baseDir . '/src/inc/db_nugetpackagesentity.php',
    'PackageGroup' => $baseDir . '/src/inc/api_packages.php',
    'PackagesApi' => $baseDir . '/src/inc/api_packages.php',
    'Pagination' => $baseDir . '/src/inc/commons/apibase.php',
    'ParserException' => $baseDir . '/src/inc/commons/objectsearch.php',
    'Path' => $baseDir . '/src/inc/commons/path.php',
    ...
    'PhpNugetExternalTypes' => $baseDir . '/src/inc/phpnugetobjectsearch.php',
    'PhpNugetObjectSearch' => $baseDir . '/src/inc/phpnugetobjectsearch.php',
    'Result' => $baseDir . '/src/inc/commons/apibase.php',
    'SMTP' => $baseDir . '/src/inc/PHPMailer/class.smtp.php',
    ...
    'Settings' => $baseDir . '/src/inc/internalsettings.php',
    'SingleResult' => $baseDir . '/src/inc/api_packages.php',
    'SmallTextDbApiBase' => $baseDir . '/src/inc/commons/smalltextdbapibase.php',
    'SmallTxtDb' => $baseDir . '/src/inc/commons/smalltxtdb.php',
    'SortClause' => $baseDir . '/src/inc/commons/objectsearch.php',
    'SubBatch' => $baseDir . '/src/api/v2/batch.php',
    ...
    'UploadUtils' => $baseDir . '/src/inc/commons/uploadutils.php',
    'UrlUtils' => $baseDir . '/src/inc/commons/url.php',
    'UserDb' => $baseDir . '/src/inc/db_users.php',
    'UserEntity' => $baseDir . '/src/inc/db_usersentity.php',
    'UsersApi' => $baseDir . '/src/inc/api_users.php',
    'Utils' => $baseDir . '/src/inc/commons/utils.php',
    'ZipManager' => $baseDir . '/src/inc/commons/zipmanager.php',
    'lib\\db\\BaseDb' => $baseDir . '/src/lib/db/BaseDb.php',
    'lib\\db\\DbStorage' => $baseDir . '/src/lib/db/DbStorage.php',
    'lib\\db\\QueryParser' => $baseDir . '/src/lib/db/QueryParser.php',
    'lib\\db\\file\\FileDbStorage' => $baseDir . '/src/lib/db/file/FileDbStorage.php',
    'lib\\db\\file\\MySqlDbStorage' => $baseDir . '/src/lib/db/mysql/MySqlDbStorage.php',
    'lib\\db\\parser\\IdentifyResult' => $baseDir . '/src/lib/db/parser/IdentifyResult.php',
    'lib\\db\\parser\\Operator' => $baseDir . '/src/lib/db/parser/Operator.php',
    'lib\\db\\parser\\SortClause' => $baseDir . '/src/lib/db/parser/SortClause.php',
    'lib\\http\\Authorization' => $baseDir . '/src/lib/http/Authorization.php',
    'lib\\http\\BaseHandler' => $baseDir . '/src/lib/http/BaseHandler.php',
    'lib\\http\\HandlerException' => $baseDir . '/src/lib/http/HandlerException.php',
    'lib\\http\\RawInputStream' => $baseDir . '/src/lib/http/RawInputStream.php',
    'lib\\http\\Request' => $baseDir . '/src/lib/http/Request.php',
    'lib\\http\\UploadManager' => $baseDir . '/src/lib/http/UploadManager.php',
    'lib\\http\\UploadedFile' => $baseDir . '/src/lib/http/UploadedFile.php',
    'lib\\nuget\\NugetDownloads' => $baseDir . '/src/lib/nuget/NugetDownloads.php',
    'lib\\nuget\\NugetFileParser' => $baseDir . '/src/lib/nuget/NugetFileParser.php',
    'lib\\nuget\\NugetPackages' => $baseDir . '/src/lib/nuget/NugetPackages.php',
    'lib\\nuget\\NugetUsers' => $baseDir . '/src/lib/nuget/NugetUsers.php',
    'lib\\nuget\\NugetUtils' => $baseDir . '/src/lib/nuget/NugetUtils.php',
    'lib\\nuget\\models\\NugetDependency' => $baseDir . '/src/lib/nuget/models/NugetDependency.php',
    'lib\\nuget\\models\\NugetPackage' => $baseDir . '/src/lib/nuget/models/NugetPackage.php',
    'lib\\nuget\\models\\NugetUser' => $baseDir . '/src/lib/nuget/models/NugetUser.php',
    'lib\\rest\\ApiRoot' => $baseDir . '/src/lib/rest/ApiRoot.php',
    'lib\\rest\\FindPackagesById' => $baseDir . '/src/lib/rest/FindPackagesById.php',
    'lib\\rest\\FindSingle' => $baseDir . '/src/lib/rest/FindSingle.php',
    'lib\\rest\\GetUpdates' => $baseDir . '/src/lib/rest/GetUpdates.php',
    'lib\\rest\\Metadata' => $baseDir . '/src/lib/rest/Metadata.php',
    'lib\\rest\\Search' => $baseDir . '/src/lib/rest/Search.php',
    'lib\\rest\\VersionRoot' => $baseDir . '/src/lib/rest/VersionRoot.php',
    'lib\\rest\\ui\\NugetResult' => $baseDir . '/src/lib/rest/ui/NugetResult.php',
    'lib\\rest\\ui\\Packages' => $baseDir . '/src/lib/rest/ui/Packages.php',
    'lib\\rest\\utils\\LastQueryBuilder' => $baseDir . '/src/lib/rest/utils/LastQueryBuilder.php',
    'lib\\rest\\utils\\NetVersionHelper' => $baseDir . '/src/lib/rest/utils/NetVersionHelper.php',
    'lib\\rest\\utils\\NugetQuery' => $baseDir . '/src/lib/rest/utils/NugetQuery.php',
    'lib\\rest\\utils\\NugetQueryHandler' => $baseDir . '/src/lib/rest/utils/NugetQueryHandler.php',
    'lib\\rest\\utils\\NugetQueryResult' => $baseDir . '/src/lib/rest/utils/NugetQueryResult.php',
    'lib\\rest\\utils\\NugetResultParser' => $baseDir . '/src/lib/rest/utils/NugetResultParser.php',
    'lib\\rest\\utils\\Pagination' => $baseDir . '/src/lib/rest/utils/Pagination.php',
    'lib\\rest\\utils\\ResourcesLoader' => $baseDir . '/src/lib/rest/utils/ResourcesLoader.php',
    'lib\\utils\\ArrayUtils' => $baseDir . '/src/lib/utils/ArrayUtils.php',
    'lib\\utils\\Guid' => $baseDir . '/src/lib/utils/Guid.php',
    'lib\\utils\\HttpUtils' => $baseDir . '/src/lib/utils/HttpUtils.php',
    'lib\\utils\\JsonMapper' => $baseDir . '/src/lib/utils/JsonMapper.php',
    'lib\\utils\\PathUtils' => $baseDir . '/src/lib/utils/PathUtils.php',
    'lib\\utils\\Properties' => $baseDir . '/src/lib/utils/Properties.php',
    'lib\\utils\\StringUtils' => $baseDir . '/src/lib/utils/StringUtils.php',
    'lib\\utils\\XmlUtils' => $baseDir . '/src/lib/utils/XmlUtils.php',
    'lib\\utils\\ZipManager' => $baseDir . '/src/lib/utils/ZipManager.php',
    'phpmailerException' => $baseDir . '/src/inc/PHPMailer/class.phpmailer.php',
    'stream' => $baseDir . '/src/inc/gerfen/class.stream.php',
);
